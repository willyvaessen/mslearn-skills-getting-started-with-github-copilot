...
activities.update({
    ...
    "Basketball Club": {
        "description": "Basketball drills, scrimmages, and local tournaments",
    ...
    "Drama Club": {
        "description": "Acting workshops and theatre productions throughout the year",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["liya@mergington.edu", "harper@mergington.edu"]
    },
    "Debate Team": {
        "description": "Competitive debate practice and regional competitions",
